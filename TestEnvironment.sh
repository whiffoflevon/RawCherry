...
az network public-ip create --resource-group MyResourceGroup --name PublicIPVM1 --allocation-method Dynamic
...
az network public-ip create --resource-group MyResourceGroup --name PublicIPVM2 --allocation-method Dynamic
...
echo "VM2 Public IP:"
az network public-ip show --resource-group MyResourceGroup --name PublicIPVM2 --query "ipAddress" --output tsv
